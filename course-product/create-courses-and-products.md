...
<figure><img src="../.gitbook/assets/course-product-structure.png" alt="강좌와 상품 관계"><figcaption></figcaption></figure>
...
자세한 내용은 [강좌 생성 가이드](course-creation-guide.md)를 확인해 주세요.
...
자세한 내용은 [커리큘럼·영상 업로드 가이드](curriculum-and-video-upload.md)를 확인해 주세요.
...
자세한 내용은 [수강 상품 생성 가이드](product-creation-guide.md)를 확인해 주세요.
