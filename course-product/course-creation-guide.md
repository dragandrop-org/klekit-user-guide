...
<figure><img src="../.gitbook/assets/course-create-flow-rail.png" alt="강좌 생성 흐름"><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/screenshots/3-1-1.png" alt="강좌 생성 기본 정보 입력 화면"><figcaption><p>강좌 생성 첫 단계에서 제목, 요약, 범위, 특징 등 기본 정보를 입력합니다.</p></figcaption></figure>
...
1. [커리큘럼·영상 업로드 가이드](curriculum-and-video-upload.md)를 보고 섹션과 강의를 등록합니다.
2. [수강 상품 생성 가이드](product-creation-guide.md)를 보고 상품을 만들고 강좌를 연결합니다.
