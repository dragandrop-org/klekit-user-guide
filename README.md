...
<figure><img src=".gitbook/assets/main-guide-banner.png" alt="클킷 사용자 가이드 배너"><figcaption></figcaption></figure>
...
{% content-ref url="getting-started/first-sales-guide.md" %}
...
|                                                                                          |                                                                                                  |                                                                                                     |
|------------------------------------------------------------------------------------------| ------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------- |
| [![](.gitbook/assets/처음판매시작.png)](getting-started/first-sales-guide.md)     | [![](.gitbook/assets/강좌만들기.png)](course-product/course-creation-guide.md)                | [![](<.gitbook/assets/커리큘럼 영상등록.png>)](course-product/curriculum-and-video-upload.md) |
